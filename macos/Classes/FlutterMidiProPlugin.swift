...
public class FlutterMidiProPlugin: NSObject, FlutterPlugin {
  ...
  private func setupAudioSessionNotifications() {
    ...
    // (output device switched, sample rate change). This does NOT fire an
    // interruption notification, so without this observer the engines stay
    // silent until the app is relaunched.
    NotificationCenter.default.addObserver(
      self,
